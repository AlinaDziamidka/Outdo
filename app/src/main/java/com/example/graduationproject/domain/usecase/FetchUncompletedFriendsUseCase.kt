...
class FetchUncompletedFriendsUseCase @Inject constructor(
...
) : UseCase<FetchUncompletedFriendsUseCase.Params, MutableList<UserProfile>> {
    ...
    override suspend fun invoke(params: Params): Flow<MutableList<UserProfile>> =
        flow {
            ...
            val completedUserAchievements =
                userAchievements.filter { it.achievementStatus == AchievementStatus.UNCOMPLETED }
